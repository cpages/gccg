...
namespace Evaluator
{
    ...
    {
        //logi << Localization::Message("Security manager: allow read file: %s",pattern) << endl;
    ...
    {
        //logi << Localization::Message("Security manager: allow write file: %s",pattern) << endl;
    ...
    {
        //logi << Localization::Message("Security manager: allow open dir: %s",pattern) << endl;
    ...
    {
        //logi << Localization::Message("Security manager: allow execute: %s",pattern) << endl;
    ...
    {
        //logi << Localization::Message("Security manager: allow connect: %s",pattern+"/"+ToString(port)) << endl;
    ...
    {
        //logi << Localization::Message("Security manager: allow create socket: %s",ToString(port)) << endl;
